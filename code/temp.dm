/client/verb/toggle_chat_panes()
//	winset(src, "outputwindow.tab",
...
//Verb to Change Available Chat Tabs
//Verb to change



client/verb/help_text_toggle()
...
/* Unused at the moment | pulled from _globalvars/Configuration.dm
...
/* Unused at the moment | pulled from controllers/Configuration.dm
